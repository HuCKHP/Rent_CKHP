		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="ftco-nav">
				<ul class="navbar-nav ml-auto">
					...
					<li class="nav-item"><a href="board" class="nav-link">Car뮤니티</a></li>
					<li class="nav-item"><a href="memberjoinview" class="nav-link">고객지원_회원가입</a></li>
					<li class="nav-item active"><a href="#myModal"
				...
				<div class="col-md-8 block-9 mb-md-5">
					<div id="joinform">
						<form class="form-group">
							<div>
								<span><b>아이디</b></span> <span><input type="text" name="id"></span>
							</div>
							<div>
								<b>비밀번호</b> <span><input type="password" name="pass"></span>
							</div>
							<div>
								<b>이름</b> <span><input type="text" name="name"></span>
							</div>
							<div>
								<b>전화번호</b> <span><input type="tel" name="tel" id="tel"
									placeholder="010-0000-0000" required
									pattern="[0-9]{3}-[0-9]{4}-[0-9]{4}" maxlength="13"
									onkeyup="keyevent();"></span>
							</div>
							<div>
								<b>생년월일</b> <span> <select name="yy" id="year"></select>년
							...
							<div>
								<b>성별</b> <span>남자<input type="radio" name="gender"
									value="M"> 여자<input type="radio" name="gender"
									value="W"></span>
							</div>
							<div>
								<b>이메일</b> 
